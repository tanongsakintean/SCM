...
$channels = ['dashboard']; // Default to dashboard since UI is removed
...
$old_res = $conn->query("SELECT credit_min, notify_channels FROM credit_setting WHERE user_id = 2");
...
$sql = "UPDATE credit_setting SET credit_min = ?, notify_channels = ? WHERE user_id = 2";
