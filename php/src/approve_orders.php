                    ...
                    <?php if ($result_pending->num_rows > 0): ?>
                        ...
                        <tr>
                            <td class="align-middle">
                                ...
                                <small class="text-muted"><i class="fas fa-tag" style="font-size: 10px; margin-right: 3px;"></i>  <?php echo $display_id; ?></small>
                            </td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p><strong>หมายเหตุ:</strong> <span id="view_note"></span></p>
      </div>
    </div>
  </div>
</div>
...
function viewDetails(data) {
    ...
    document.getElementById('view_order_id').innerText = displayId;
    ...
    document.getElementById('view_quantity').innerText = data.order_quantity; // You might want to format this
    document.getElementById('view_date').innerText = data.order_date;
    // Translate Status
    let statusText = data.order_status;
    if (data.order_status === 'Pending') statusText = 'รออนุมัติ';
    else if (data.order_status === 'Approved') statusText = 'อนุมัติแล้ว';
    else if (data.order_status === 'Rejected') statusText = 'ปฏิเสธแล้ว';
